...
def load_from_standard_weights(input_file: str, device: str) -> dict[str, torch.Tensor]:
    ...
    converted["diffusion"]["unet.encoders.1.1.attention_1.out_proj.weight"] = (
        original_model[
            "model.diffusion_model.input_blocks.1.1.transformer_blocks.0.attn1.to_out.0.weight"
        ]
    )
    converted["diffusion"]["unet.encoders.1.1.attention_1.out_proj.bias"] = (
        original_model[
    ...
    converted["diffusion"]["unet.encoders.1.1.attention_2.k_proj.weight"] = (
        original_model[
            "model.diffusion_model.input_blocks.1.1.transformer_blocks.0.attn2.to_k.weight"
        ]
    )
    converted["diffusion"]["unet.encoders.1.1.attention_2.v_proj.weight"] = (
        original_model[
            "model.diffusion_model.input_blocks.1.1.transformer_blocks.0.attn2.to_v.weight"
        ]
    )
    converted["diffusion"]["unet.encoders.1.1.attention_2.out_proj.weight"] = (
        original_model[
            "model.diffusion_model.input_blocks.1.1.transformer_blocks.0.attn2.to_out.0.weight"
        ]
    )
    converted["diffusion"]["unet.encoders.1.1.attention_2.out_proj.bias"] = (
        original_model[
    ...
    converted["diffusion"]["unet.encoders.2.1.attention_1.out_proj.weight"] = (
        original_model[
            "model.diffusion_model.input_blocks.2.1.transformer_blocks.0.attn1.to_out.0.weight"
        ]
    )
    converted["diffusion"]["unet.encoders.2.1.attention_1.out_proj.bias"] = (
        original_model[
    ...
    converted["diffusion"]["unet.encoders.2.1.attention_2.k_proj.weight"] = (
        original_model[
            "model.diffusion_model.input_blocks.2.1.transformer_blocks.0.attn2.to_k.weight"
        ]
    )
    converted["diffusion"]["unet.encoders.2.1.attention_2.v_proj.weight"] = (
        original_model[
            "model.diffusion_model.input_blocks.2.1.transformer_blocks.0.attn2.to_v.weight"
        ]
    )
    converted["diffusion"]["unet.encoders.2.1.attention_2.out_proj.weight"] = (
        original_model[
            "model.diffusion_model.input_blocks.2.1.transformer_blocks.0.attn2.to_out.0.weight"
        ]
    )
    converted["diffusion"]["unet.encoders.2.1.attention_2.out_proj.bias"] = (
        original_model[
    ...
    converted["diffusion"]["unet.encoders.4.1.attention_1.out_proj.weight"] = (
        original_model[
            "model.diffusion_model.input_blocks.4.1.transformer_blocks.0.attn1.to_out.0.weight"
        ]
    )
    converted["diffusion"]["unet.encoders.4.1.attention_1.out_proj.bias"] = (
        original_model[
    ...
    converted["diffusion"]["unet.encoders.4.1.attention_2.k_proj.weight"] = (
        original_model[
            "model.diffusion_model.input_blocks.4.1.transformer_blocks.0.attn2.to_k.weight"
        ]
    )
    converted["diffusion"]["unet.encoders.4.1.attention_2.v_proj.weight"] = (
        original_model[
            "model.diffusion_model.input_blocks.4.1.transformer_blocks.0.attn2.to_v.weight"
        ]
    )
    converted["diffusion"]["unet.encoders.4.1.attention_2.out_proj.weight"] = (
        original_model[
            "model.diffusion_model.input_blocks.4.1.transformer_blocks.0.attn2.to_out.0.weight"
        ]
    )
    converted["diffusion"]["unet.encoders.4.1.attention_2.out_proj.bias"] = (
        original_model[
    ...
    converted["diffusion"]["unet.encoders.5.1.attention_1.out_proj.weight"] = (
        original_model[
            "model.diffusion_model.input_blocks.5.1.transformer_blocks.0.attn1.to_out.0.weight"
        ]
    )
    converted["diffusion"]["unet.encoders.5.1.attention_1.out_proj.bias"] = (
        original_model[
    ...
    converted["diffusion"]["unet.encoders.5.1.attention_2.k_proj.weight"] = (
        original_model[
            "model.diffusion_model.input_blocks.5.1.transformer_blocks.0.attn2.to_k.weight"
        ]
    )
    converted["diffusion"]["unet.encoders.5.1.attention_2.v_proj.weight"] = (
        original_model[
            "model.diffusion_model.input_blocks.5.1.transformer_blocks.0.attn2.to_v.weight"
        ]
    )
    converted["diffusion"]["unet.encoders.5.1.attention_2.out_proj.weight"] = (
        original_model[
            "model.diffusion_model.input_blocks.5.1.transformer_blocks.0.attn2.to_out.0.weight"
        ]
    )
    converted["diffusion"]["unet.encoders.5.1.attention_2.out_proj.bias"] = (
        original_model[
    ...
    converted["diffusion"]["unet.encoders.7.1.attention_1.out_proj.weight"] = (
        original_model[
            "model.diffusion_model.input_blocks.7.1.transformer_blocks.0.attn1.to_out.0.weight"
        ]
    )
    converted["diffusion"]["unet.encoders.7.1.attention_1.out_proj.bias"] = (
        original_model[
    ...
    converted["diffusion"]["unet.encoders.7.1.attention_2.k_proj.weight"] = (
        original_model[
            "model.diffusion_model.input_blocks.7.1.transformer_blocks.0.attn2.to_k.weight"
        ]
    )
    converted["diffusion"]["unet.encoders.7.1.attention_2.v_proj.weight"] = (
        original_model[
            "model.diffusion_model.input_blocks.7.1.transformer_blocks.0.attn2.to_v.weight"
        ]
    )
    converted["diffusion"]["unet.encoders.7.1.attention_2.out_proj.weight"] = (
        original_model[
            "model.diffusion_model.input_blocks.7.1.transformer_blocks.0.attn2.to_out.0.weight"
        ]
    )
    converted["diffusion"]["unet.encoders.7.1.attention_2.out_proj.bias"] = (
        original_model[
    ...
    converted["diffusion"]["unet.encoders.8.1.attention_1.out_proj.weight"] = (
        original_model[
            "model.diffusion_model.input_blocks.8.1.transformer_blocks.0.attn1.to_out.0.weight"
        ]
    )
    converted["diffusion"]["unet.encoders.8.1.attention_1.out_proj.bias"] = (
        original_model[
    ...
    converted["diffusion"]["unet.encoders.8.1.attention_2.k_proj.weight"] = (
        original_model[
            "model.diffusion_model.input_blocks.8.1.transformer_blocks.0.attn2.to_k.weight"
        ]
    )
    converted["diffusion"]["unet.encoders.8.1.attention_2.v_proj.weight"] = (
        original_model[
            "model.diffusion_model.input_blocks.8.1.transformer_blocks.0.attn2.to_v.weight"
        ]
    )
    converted["diffusion"]["unet.encoders.8.1.attention_2.out_proj.weight"] = (
        original_model[
            "model.diffusion_model.input_blocks.8.1.transformer_blocks.0.attn2.to_out.0.weight"
        ]
    )
    converted["diffusion"]["unet.encoders.8.1.attention_2.out_proj.bias"] = (
        original_model[
    ...
    converted["diffusion"]["unet.decoders.3.1.attention_1.out_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.3.1.transformer_blocks.0.attn1.to_out.0.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.3.1.attention_1.out_proj.bias"] = (
        original_model[
    ...
    converted["diffusion"]["unet.decoders.3.1.attention_2.q_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.3.1.transformer_blocks.0.attn2.to_q.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.3.1.attention_2.k_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.3.1.transformer_blocks.0.attn2.to_k.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.3.1.attention_2.v_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.3.1.transformer_blocks.0.attn2.to_v.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.3.1.attention_2.out_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.3.1.transformer_blocks.0.attn2.to_out.0.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.3.1.attention_2.out_proj.bias"] = (
        original_model[
    ...
    converted["diffusion"]["unet.decoders.4.1.attention_1.out_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.4.1.transformer_blocks.0.attn1.to_out.0.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.4.1.attention_1.out_proj.bias"] = (
        original_model[
    ...
    converted["diffusion"]["unet.decoders.4.1.attention_2.q_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.4.1.transformer_blocks.0.attn2.to_q.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.4.1.attention_2.k_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.4.1.transformer_blocks.0.attn2.to_k.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.4.1.attention_2.v_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.4.1.transformer_blocks.0.attn2.to_v.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.4.1.attention_2.out_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.4.1.transformer_blocks.0.attn2.to_out.0.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.4.1.attention_2.out_proj.bias"] = (
        original_model[
    ...
    converted["diffusion"]["unet.decoders.5.1.attention_1.out_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.5.1.transformer_blocks.0.attn1.to_out.0.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.5.1.attention_1.out_proj.bias"] = (
        original_model[
    ...
    converted["diffusion"]["unet.decoders.5.1.attention_2.q_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.5.1.transformer_blocks.0.attn2.to_q.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.5.1.attention_2.k_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.5.1.transformer_blocks.0.attn2.to_k.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.5.1.attention_2.v_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.5.1.transformer_blocks.0.attn2.to_v.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.5.1.attention_2.out_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.5.1.transformer_blocks.0.attn2.to_out.0.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.5.1.attention_2.out_proj.bias"] = (
        original_model[
    ...
    converted["diffusion"]["unet.decoders.6.1.attention_1.out_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.6.1.transformer_blocks.0.attn1.to_out.0.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.6.1.attention_1.out_proj.bias"] = (
        original_model[
    ...
    converted["diffusion"]["unet.decoders.6.1.attention_2.q_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.6.1.transformer_blocks.0.attn2.to_q.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.6.1.attention_2.k_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.6.1.transformer_blocks.0.attn2.to_k.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.6.1.attention_2.v_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.6.1.transformer_blocks.0.attn2.to_v.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.6.1.attention_2.out_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.6.1.transformer_blocks.0.attn2.to_out.0.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.6.1.attention_2.out_proj.bias"] = (
        original_model[
    ...
    converted["diffusion"]["unet.decoders.7.1.attention_1.out_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.7.1.transformer_blocks.0.attn1.to_out.0.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.7.1.attention_1.out_proj.bias"] = (
        original_model[
    ...
    converted["diffusion"]["unet.decoders.7.1.attention_2.q_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.7.1.transformer_blocks.0.attn2.to_q.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.7.1.attention_2.k_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.7.1.transformer_blocks.0.attn2.to_k.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.7.1.attention_2.v_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.7.1.transformer_blocks.0.attn2.to_v.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.7.1.attention_2.out_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.7.1.transformer_blocks.0.attn2.to_out.0.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.7.1.attention_2.out_proj.bias"] = (
        original_model[
    ...
    converted["diffusion"]["unet.decoders.8.1.attention_1.out_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.8.1.transformer_blocks.0.attn1.to_out.0.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.8.1.attention_1.out_proj.bias"] = (
        original_model[
    ...
    converted["diffusion"]["unet.decoders.8.1.attention_2.q_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.8.1.transformer_blocks.0.attn2.to_q.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.8.1.attention_2.k_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.8.1.transformer_blocks.0.attn2.to_k.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.8.1.attention_2.v_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.8.1.transformer_blocks.0.attn2.to_v.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.8.1.attention_2.out_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.8.1.transformer_blocks.0.attn2.to_out.0.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.8.1.attention_2.out_proj.bias"] = (
        original_model[
    ...
    converted["diffusion"]["unet.decoders.9.1.attention_1.out_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.9.1.transformer_blocks.0.attn1.to_out.0.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.9.1.attention_1.out_proj.bias"] = (
        original_model[
    ...
    converted["diffusion"]["unet.decoders.9.1.attention_2.q_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.9.1.transformer_blocks.0.attn2.to_q.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.9.1.attention_2.k_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.9.1.transformer_blocks.0.attn2.to_k.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.9.1.attention_2.v_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.9.1.transformer_blocks.0.attn2.to_v.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.9.1.attention_2.out_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.9.1.transformer_blocks.0.attn2.to_out.0.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.9.1.attention_2.out_proj.bias"] = (
        original_model[
    ...
    converted["diffusion"]["unet.decoders.10.1.attention_1.out_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.10.1.transformer_blocks.0.attn1.to_out.0.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.10.1.attention_1.out_proj.bias"] = (
        original_model[
    ...
    converted["diffusion"]["unet.decoders.10.1.attention_2.q_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.10.1.transformer_blocks.0.attn2.to_q.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.10.1.attention_2.k_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.10.1.transformer_blocks.0.attn2.to_k.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.10.1.attention_2.v_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.10.1.transformer_blocks.0.attn2.to_v.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.10.1.attention_2.out_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.10.1.transformer_blocks.0.attn2.to_out.0.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.10.1.attention_2.out_proj.bias"] = (
        original_model[
    ...
    converted["diffusion"]["unet.decoders.11.1.attention_1.out_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.11.1.transformer_blocks.0.attn1.to_out.0.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.11.1.attention_1.out_proj.bias"] = (
        original_model[
    ...
    converted["diffusion"]["unet.decoders.11.1.attention_2.q_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.11.1.transformer_blocks.0.attn2.to_q.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.11.1.attention_2.k_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.11.1.transformer_blocks.0.attn2.to_k.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.11.1.attention_2.v_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.11.1.transformer_blocks.0.attn2.to_v.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.11.1.attention_2.out_proj.weight"] = (
        original_model[
            "model.diffusion_model.output_blocks.11.1.transformer_blocks.0.attn2.to_out.0.weight"
        ]
    )
    converted["diffusion"]["unet.decoders.11.1.attention_2.out_proj.bias"] = (
        original_model[
